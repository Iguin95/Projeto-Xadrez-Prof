...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		//Movimento especial promoção(Ela está antes da verificação do xeque pois a promoção do peão pode deixar o rei adversário em xeque)
		promoted = null;
	...
	private void initialSetup() { //método responsável por iniciar a partida de Xadrez, colocando as peças no tabuleiro
	        ...
	        placeNewPiece('e', 1, new King(board, Color.WHITE, this));/*o this é uma auto-referência a própria classe, e aqui serve como terceiro parâmetro do construtor do rei*/
